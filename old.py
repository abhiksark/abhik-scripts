{
    ...
    "wiredTiger" : {
        ...
        "type" : "file",
        "uri" : "statistics:table:collection-20--3791865192942730797",
        "LSM" : {
        ...
        "block-manager" : {
            "allocations requiring file extension" : 49148.0,
            "blocks allocated" : 1553309.0,
            "blocks freed" : 1550314.0,
            "checkpoint size" : 18569302016,
            "file allocation unit size" : 4096.0,
            "file bytes available for reuse" : 1115099136.0,
            "file magic number" : 120897.0,
            "file major version number" : 1.0,
            "file size in bytes" : 19684425728,
            "minor version number" : 0.0
        },
        "btree" : {
            "btree checkpoint generation" : 3288.0,
        ...
        "cache" : {
            "bytes currently in the cache" : 5643511147,
            "bytes dirty in the cache cumulative" : 223384450395,
            "bytes read into cache" : 264504808071,
            "bytes written from cache" : 162890255449,
            "checkpoint blocked page eviction" : 6469.0,
            "checkpoint of history store file blocked non-history store page eviction" : 0.0,
            "data source pages selected for eviction unable to be evicted" : 13239.0,
            ...
            "eviction walk passes of a file" : 169649.0,
            "eviction walk target pages histogram - 0-9" : 6899.0,
            "eviction walk target pages histogram - 10-31" : 15790.0,
            "eviction walk target pages histogram - 128 and higher" : 0.0,
            "eviction walk target pages histogram - 32-63" : 21929.0,
            "eviction walk target pages histogram - 64-128" : 125031.0,
            "eviction walk target pages reduced due to history store cache pressure" : 0.0,
            "eviction walks abandoned" : 2917.0,
            "eviction walks gave up because they restarted their walk twice" : 9.0,
            "eviction walks gave up because they saw too many pages and found no candidates" : 4330.0,
            "eviction walks gave up because they saw too many pages and found too few candidates" : 4908.0,
            "eviction walks reached end of tree" : 10714.0,
            "eviction walks restarted" : 0.0,
            "eviction walks started from root of tree" : 12164.0,
            "eviction walks started from saved location in tree" : 157485.0,
            "hazard pointer blocked page eviction" : 4822.0,
            "history store table insert calls" : 14854.0,
            ...
            "history store table reads" : 12.0,
            ...
            "internal pages evicted" : 18945.0,
            "internal pages split during eviction" : 0.0,
            "leaf pages split during eviction" : 2208.0,
            "modified pages evicted" : 1548957.0,
            "overflow pages read into cache" : 0.0,
            "page split during eviction deepened the tree" : 0.0,
            "page written requiring history store records" : 1911.0,
            "pages read into cache" : 2514912.0,
            "pages read into cache after truncate" : 0.0,
            "pages read into cache after truncate in prepare state" : 0.0,
            "pages requested from the cache" : 84988994.0,
            "pages seen by eviction walk" : 95761650.0,
            "pages written from cache" : 1552787.0,
            "pages written requiring in-memory restoration" : 1455238.0,
            "tracked dirty bytes in the cache" : 0.0,
            "unmodified pages evicted" : 2372374.0
        },
        "cache_walk" : {
        ...
        "checkpoint-cleanup" : {
            ...
            "pages removed" : 0.0,
            "pages skipped during tree walk" : 3662384.0,
            "pages visited" : 6474191.0
        },
        "compression" : {
            ...
            "compressed pages read" : 2494582.0,
            "compressed pages written" : 1536688.0,
            "page written failed to compress" : 0.0,
            "page written was too small to compress" : 16099.0
        },
        "cursor" : {
            ...
            "cache cursors reuse count" : 22.0,
            "close calls that result in cache" : 24.0,
            "create calls" : 11.0,
            ...
            "cursor next calls that skip less than 100 entries" : 33260706.0,
            ...
            "insert calls" : 12835848.0,
            "insert key and value bytes" : 162729137056,
            "modify" : 0.0,
            "modify key and value bytes affected" : 0.0,
            "modify value bytes modified" : 0.0,
            "next calls" : 33260706.0,
            ...
            "reserve calls" : 0.0,
            "reset calls" : 26040196.0,
            "search calls" : 12835898.0,
            "search history store calls" : 12.0,
            "search near calls" : 13204296.0,
            "truncate calls" : 0.0,
            "update calls" : 0.0,
        ...
        "reconciliation" : {
            ...
            "approximate byte size of transaction IDs in pages written" : 119024.0,
            "dictionary matches" : 0.0,
            "fast-path pages deleted" : 0.0,
            "internal page key bytes discarded using suffix compression" : 1616161.0,
            ...
            "leaf page multi-block writes" : 2209.0,
            "leaf-page overflow keys" : 0.0,
            "maximum blocks required for a page" : 1.0,
            "overflow values written" : 0.0,
            "page checksum matches" : 0.0,
            "page reconciliation calls" : 1550586.0,
            "page reconciliation calls for eviction" : 1459087.0,
            "pages deleted" : 0.0,
            ...
            "pages written including an aggregated newest transaction ID " : 504.0,
            ...
            "pages written including at least one start transaction ID" : 1913.0,
            ...
            "records written including a start transaction ID" : 14878.0,
    ...
    "size" : 81371068817,
    "count" : 6417924.0,
    "storageSize" : 19684425728,
    "totalIndexSize" : 187371520.0,
    "totalSize" : 19871797248,
    "indexSizes" : {
        "_id_" : 121856000.0,
        "day-1" : 29933568.0,
        "account_id-1" : 35581952.0
    },
    "avgObjSize" : 12678.0,
    "ns" : "prod_archive.prod_tagger_archive_jul_w3",
    "nindexes" : 3.0,
    "scaleFactor" : 1.0
}
